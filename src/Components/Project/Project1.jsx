...
const Project1 = () => {
    return (
        ...
        <div className="cs_height_1 cs_height_lg_80"></div>
        <div className="container">
          <div className="cs_section_heading cs_style_1 cs_type_1">
            <div className="cs_section_heading_left">
                <SectionTitle
                    SubTitle="Algunos Proyectos Terminados"
                    Title="Asesorate con expertos"           
                ></SectionTitle>
            </div>
          </div>
                    ...
                    <div className="cs_card cs_style_2 position-relative">
                      ...
                      <div className="cs_card_info cs_white_bg">
                        ...
                        <Link to="#" className="cs_text_btn cs_style_1 cs_bold cs_heading_color">
                          <span className="cs_btn_text text-uppercase">Ver más</span>
