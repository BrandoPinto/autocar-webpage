...
const About1 = ({img1,img2,img3,expNumber,expYers,expTitle,number,subTitle,Title,Content,feature1,feature2,listItem}) => {
    return (
             ...
             <div className="col-xl-6">
               <div className="cs_about_text">
                 ...
                 <div className="cs_about_btns">
                   <Link to="/contacto" className="cs_btn cs_style_1 wow fadeInLeft">
